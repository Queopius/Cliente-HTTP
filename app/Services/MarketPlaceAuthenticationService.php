...
class MarketPlaceAuthenticationService
{
    /**
    ...
    {
        $this->baseUri = config('services.marketplace.base_uri');
        $this->clientId = config('services.marketplace.client_id');
        $this->clientSecret = config('services.marketplace.client_secret');
        $this->passwordClientId = config('services.marketplace.password_client_id');
        $this->passwordClientSecret = config('services.marketplace.password_client_secret');
    }
